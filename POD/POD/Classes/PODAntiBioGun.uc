...
//  PODAntiBioGun.uc ::
// ============================================================================
class PODAntiBioGun extends PODWeapon;
...
{
    local PODAntiBioProjectile Rocket;
    local bot B;
    ...
    Rocket = Spawn(class'PODAntiBioProjectile',,, Start, Dir);
...
defaultproperties
{
    ...
    FireModeClass(0)                = PODAntiBioFire
    FireModeClass(1)                = PODAntiBioFire
    InventoryGroup                  = 8
