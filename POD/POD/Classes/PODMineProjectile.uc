// ============================================================================
//  PODMineProjectile.uc ::
// ============================================================================
class PODMineProjectile extends PODProjectile;
...
{
    local PODMineProjectile P;

    Super.InitCopy(PR);

    P = PODMineProjectile(PR);
    if( PODMineGun(Owner) != None )
    {
        P.SetOwner(Owner);
        PODMineGun(Owner).Grenades[PODMineGun(Owner).Grenades.length] = P;
        PODMineGun(Owner).CurrentGrenades++;
    }
}
